...
TEST(AuroraSnarkTest, SimpleTest) {
    ...
    const std::size_t num_constraints = 1 << 5;
    const std::size_t num_inputs = (1 << 1) - 1;
    const std::size_t num_variables = (1 << 5) - 1;
    ...
    for (std::size_t i = 0; i < 2; i++) {
        ...
        std::cout << "Total proving time (milliseconds): " << duration1<< std::endl;
        std::cout << "Total verification time (milliseconds): " << duration2<< std::endl;
